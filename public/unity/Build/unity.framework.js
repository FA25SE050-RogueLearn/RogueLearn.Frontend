...
var ASM_CONSTS = {
  7566416: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 7566477: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 7566541: function() {return Module.webglContextAttributes.powerPreference;},  
 7566599: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 7566654: function($0) {performance.now = function() { return $0; };},  
 7566702: function($0) {performance.now = function() { return $0; };},  
 7566750: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _BMad_SendAnswer(msgPtr) {
  ...
  function _BMad_SendComplete(msgPtr) {
      var msg = UTF8ToString(msgPtr);
      try {
        if (window.parent && window.parent !== window) {
  ...
  function _BMad_SendError(msgPtr) {
      var msg = UTF8ToString(msgPtr);
      try {
        if (window.parent && window.parent !== window) {
  ...
  function _BMad_SendInit(msgPtr) {
      var msg = UTF8ToString(msgPtr);
      try {
        if (window.parent && window.parent !== window) {
  ...
  function _BMad_SendProgress(msgPtr) {
      var msg = UTF8ToString(msgPtr);
      try {
        if (window.parent && window.parent !== window) {
  ...
  function _BMad_SendQuestion(msgPtr) {
      var msg = UTF8ToString(msgPtr);
      try {
        if (window.parent && window.parent !== window) {
...
var asmLibraryArg = {
  "BMad_SendAnswer": _BMad_SendAnswer,
  "BMad_SendComplete": _BMad_SendComplete,
  "BMad_SendError": _BMad_SendError,
  "BMad_SendInit": _BMad_SendInit,
  "BMad_SendProgress": _BMad_SendProgress,
  "BMad_SendQuestion": _BMad_SendQuestion,
