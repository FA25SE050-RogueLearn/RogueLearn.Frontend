// roguelearn-web/src/components/layout/SidebarNav.tsx
"use client";
...
import { AcademicRecordModal } from "@/components/profile/AcademicRecordModal";
...
export function SidebarNav({ userProfile }: SidebarNavProps) {
  ...
  const [academicRecordOpen, setAcademicRecordOpen] = useState(false);
  ...
  return (
    <>
      ...
      <AcademicRecordModal isOpen={academicRecordOpen} onOpenChange={setAcademicRecordOpen} />
          ...
          <div className="flex flex-1 flex-col space-y-4 py-4">
                ...
                <Tooltip key={item.url}>
                  <TooltipTrigger asChild>
                    <button
                      ...
                      className={`group relative flex h-12 w-12 items-center justify-center rounded-full transition-all duration-200 hover:bg-[#f5c16c]/15 ${isActive
            ...
            <DropdownMenu>
              ...
              >
                ...
                {/* Added Academic Record Item */}
                <DropdownMenuItem
                  onClick={() => setAcademicRecordOpen(true)}
                  className="cursor-pointer text-[#f5c16c]/80 hover:bg-[#f5c16c]/15 hover:text-[#f5c16c]"
                >
