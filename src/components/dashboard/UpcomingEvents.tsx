...
export function UpcomingEvents() {
  return (
    <Card className="relative h-full overflow-hidden rounded-3xl border border-[#f5c16c]/22 bg-[#28130d]/88 p-6 text-[#f5c16c] shadow-[0_20px_60px_rgba(38,12,6,0.6)]">
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg-linear-to-b from-[#30150f]/95 via-[#1c0c08]/88 to-[#0d0504]/92" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(245,193,108,0.28),transparent_62%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom,rgba(210,49,135,0.24),transparent_65%)]" />
      </div>
      ...
      <div className="relative z-10">
        ...
        <CardContent className="space-y-4">
          {mockQuests.upcomingEvents.map((event, index) => (
            ...
            >
              <div className="absolute inset-y-0 left-0 w-1 bg-linear-to-b from-[#f5c16c] via-[#d23187] to-transparent" />
              <div className="ml-4">
