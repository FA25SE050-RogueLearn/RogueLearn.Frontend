...
export function GuildHeader({ name, createdAt }: GuildHeaderProps) {
  return (
    <div className="flex items-center justify-between rounded-2xl border border-white/12 bg-gradient-to-r from-white/12 via-white/5 to-transparent p-5 text-foreground shadow-[0_14px_40px_rgba(26,6,12,0.4)] backdrop-blur-xl">
