...
// Create a dedicated Axios instance for the User Service.
export const userApiClient = axios.create({
  baseURL: process.env.NEXT_PUBLIC_USER_API_URL,
});

// Create a dedicated Axios instance for the Quest Service.
export const questApiClient = axios.create({
  baseURL: process.env.NEXT_PUBLIC_QUEST_API_URL,
});

// Create a dedicated Axios instance for the Code Battle Service.
...
questApiClient.interceptors.request.use(authInterceptor);
