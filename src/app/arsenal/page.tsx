      ...
      <div className="flex flex-col gap-6 pb-24">
        ...
        <Tabs defaultValue="notes" className="relative z-10">
          <TabsList className="grid w-full max-w-[340px] grid-cols-2 rounded-lg border border-[#f5c16c]/20 bg-black/40 p-1">
            <TabsTrigger value="notes" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-[#f5c16c] data-[state=active]:to-[#d4a855] data-[state=active]:text-black data-[state=inactive]:text-white/70">Notes</TabsTrigger>
            <TabsTrigger value="tags" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-[#f5c16c] data-[state=active]:to-[#d4a855] data-[state=active]:text-black data-[state=inactive]:text-white/70">Tags</TabsTrigger>
          </TabsList>
